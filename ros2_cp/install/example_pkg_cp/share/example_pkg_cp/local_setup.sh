...
: ${AMENT_CURRENT_PREFIX:="/root/ros2_cp/install/example_pkg_cp"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/example_pkg_cp/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/example_pkg_cp/environment/path.sh"
