...
{
  new (message_memory) my_interfaces::msg::Person(_init);
}

void Person_fini_function(void * message_memory)
{
  auto typed_message = static_cast<my_interfaces::msg::Person *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Person_message_member_array[3] = {
  {
    ...
    offsetof(my_interfaces::msg::Person, name),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(my_interfaces::msg::Person, age),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(my_interfaces::msg::Person, height),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Person_message_members = {
  ...
  "Person",  // message name
  3,  // number of fields
  sizeof(my_interfaces::msg::Person),
...
get_message_type_support_handle<my_interfaces::msg::Person>()
{
  return &::my_interfaces::msg::rosidl_typesupport_introspection_cpp::Person_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, my_interfaces, msg, Person)() {
  return &::my_interfaces::msg::rosidl_typesupport_introspection_cpp::Person_message_type_support_handle;
}
